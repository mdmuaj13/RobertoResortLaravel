<!DOCTYPE html>
<html lang="en-US">
@include('frontend.theme.ui.inc.head')
<body>


{{-- @include('frontend.theme.ui.inc.navbar') --}}
    <!-- Preloader -->
    <div id="preloader">
...
@include('frontend.theme.ui.inc.navbar')
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image:  url({{ asset('frontend/img/bg-img/9.jpg') }})" data-img-url=" {{ asset('public\frontend\img\bg-img\9.jpg') }}">
                <!-- Welcome Content -->
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{ asset('frontend/img/bg-img/16.jpg') }});" data-img-url="img/bg-img/17.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{ asset('frontend/img/bg-img/17.jpg') }});" data-img-url="img/bg-img/18.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
    ...
    <section class="roberto-rooms-area">
        <div class="rooms-slides owl-carousel">
            ...
            <div class="single-room-slide d-flex align-items-center">
                <!-- Thumbnail -->
                <div class="room-thumbnail h-100 bg-img" style="background-image: url({{ asset('frontend/img/bg-img/16.jpg')}});"></div>
            ...
            <div class="single-room-slide d-flex align-items-center">
                <!-- Thumbnail -->
                <div class="room-thumbnail h-100 bg-img" style="background-image: url({{ asset('frontend/img/bg-img/17.jpg')}});"></div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="testimonial-thumbnail owl-carousel mb-100">
                        <img src="{{ asset('frontend/img/bg-img/10.jpg')}}" alt="">
                        <img src="{{ asset('frontend/img/bg-img/11.jpg')}}" alt="">
                    </div>
                </div>
    ...
    <section class="roberto-project-area">
        ...
        <div class="projects-slides owl-carousel">
            ...
            <div class="single-project-slide active bg-img" style="background-image: url({{ asset('frontend/img/bg-img/5.jpg')}});">
                <!-- Project Text -->
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url({{ asset('frontend/img/bg-img/6.jpg')}});">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url({{ asset('frontend/img/bg-img/7.jpg')}});">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url({{ asset('frontend/img/bg-img/8.jpg')}});">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url({{ asset('frontend/img/bg-img/9.jpg')}});">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
    ...
    <section class="roberto-cta-area">
        <div class="container">
            <div class="cta-content bg-img bg-overlay jarallax" style="background-image: url({{ asset('frontendimg/bg-img/1.jpg')}});">
                <div class="row align-items-center">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="partner-logo-content d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="300ms">
                        <!-- Single Partner Logo -->
                        <a href="#" class="partner-logo"><img src="{{ asset('frontendimg/core-img/p1.png')}} " alt=""></a>
                        <!-- Single Partner Logo -->
                        <a href="#" class="partner-logo"><img src="{{ asset('frontendimg/core-img/p2.png')}}" alt=""></a>
                        <!-- Single Partner Logo -->
                        <a href="#" class="partner-logo"><img src="{{ asset('frontendimg/core-img/p3.png')}}" alt=""></a>
                        <!-- Single Partner Logo -->
                        <a href="#" class="partner-logo"><img src="{{ asset('frontendimg/core-img/p4.png')}}" alt=""></a>
                        <!-- Single Partner Logo -->
                        <a href="#" class="partner-logo"><img src="{{ asset('frontendimg/core-img/p5.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Partner Area End -->
{{-- footer--}}
@include('frontend.theme.ui.inc.footer')

@include('frontend.theme.ui.inc.scripts')
